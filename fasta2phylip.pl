...
#my $totNumChar = 12;  # number of characters allowed for name in phylip
my $totNumChar = 16;  # number of characters allowed for name in phylip
#my $numFrontChar = 7; # When the name is too long, this amount of characters
my $numFrontChar = 16; # When the name is too long, this amount of characters
...
#	    printf $tmpFH "%12s", $shortName;
	    printf $tmpFH "%20s", $shortName;
	}
    } else {
	$seqLen += CharLen ($_);
	print $tmpFH $_;
